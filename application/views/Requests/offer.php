		...
		<div class="modal fade" id="DeleteRequest">
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<form action="<?php echo $this->config->base_url(); ?>index.php/employee/deleteoffer" method="post">
						<div class="modal-body">
					...
					<button class="btn btn-default addbtn" data-toggle='modal' data-target="#AddRequest">أضف طلب</button>
					  <form id="SearchForm" class="col-md-7 col-md-offset-4 col-sm-12 col-xs-12">
						...
						<th>اسم الموظف</th>
							...
							echo '<tbody>';
							echo '<tr>';
							echo "<td>".$offers[$i]->custid."</td>";	
							echo "<td>".$offers[$i]->name."</td>";
							echo "<td>".$offers[$i]->date."</td>";
							echo "<td><a type='button' class='edit-offer' data-toggle='modal' data-target='#EditRequest'  data-target='#EditEmployee'
                                                                     data-date='".$offers[$i]->date."'
                                                                     data-period='".$offers[$i]->period."'
                                                                     data-purpose='".$offers[$i]->purpose."'
                                                                     ...
                                                                     data-area2='".$offers[$i]->area2."'

                                                                     data-area3='".$offers[$i]->area3."'
                                                                     data-area4='".$offers[$i]->area4."'
                                                                     data-size='".$offers[$i]->size."'

                                                                     data-floors='".$offers[$i]->floors."'
                                                                     data-rooms='".$offers[$i]->rooms."'
                                                                     data-reception='".$offers[$i]->reception."'

                                                                     data-bathroom='".$offers[$i]->bathroom."'
                                                                     data-extra='".$offers[$i]->extra."'
                                                                     data-check_date1='".$offers[$i]->check_date1."'

                                                                     data-check_date2='".$offers[$i]->check_date2."'
                                                                     data-check_date3='".$offers[$i]->check_date3."'
                                                                     data-notes='".$offers[$i]->notes."'

                                                                     data-customer_name='".$offers[$i]->customer_name."'
                                                                     data-customer_job='".$offers[$i]->customer_job."'
                                                                     data-customer_phone1='".$offers[$i]->customer_phone1."'
                                                                     data-customer_phone2='".$offers[$i]->customer_phone2."'

                                                                     data-source='".$offers[$i]->source."'
                                                                     data-employee_id='".$offers[$i]->employee_id."'
                                                                    
                                                                     >"."<i class='fa fa-pencil-square-o'></i></a></td>";
                                echo "<td><a type='button' href='#' class='delete-offer' data-toggle='modal' data-target='#DeleteRequest' data-id='".$offers[$i]->custid."'><i class='fa fa-trash' aria-hidden='true'></i></a></td>";		
